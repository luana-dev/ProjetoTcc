...
public class AdapterGrid extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            viewHolder.img = convertView.findViewById(R.id.imageGridPefil);
            viewHolder.progress = convertView.findViewById(R.id.progressGridPerfil);
        ...
        imageLoader.displayImage(urlimg, viewHolder.img, new ImageLoadingListener() {
            @Override
